...
function DeliveryModal({ order, onClose, onConfirm, onDispute, saving }) {
  ...
  const rows = [['Login email', details.email], ['Username / ID', details.username], ['Password', details.password], ['Recovery details', details.recovery], ['Seller notes', details.notes]].filter(([,value]) => value);
