...
export default function MyOrders() {
  ...
  return <main className="min-h-screen bg-zinc-50 px-5 pb-20 pt-28 text-zinc-950 sm:px-8"><div className="mx-auto max-w-6xl">
    <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between"><div><p className="text-[10px] font-black uppercase tracking-[0.2em] text-[#b77e00]">Buyer account</p><h1 className="mt-2 text-2xl font-black tracking-[-0.04em] sm:text-4xl">My orders</h1><p className="mt-3 text-sm text-zinc-500">Receive deliveries, confirm orders and request help in one place.</p></div><Link to="/#games" className="inline-flex w-fit items-center rounded-full bg-zinc-950 px-5 py-3 text-sm font-bold text-white">Browse games <span className="ml-2">→</span></Link></div>
