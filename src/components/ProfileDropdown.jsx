...
export default function ProfileDropdown({ user, onLogout }) {
  ...
  const itemClass = 'flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-left text-sm font-medium text-zinc-800 transition hover:bg-zinc-50';
  ...
  return <div>
    ...
    {open && createPortal(<div className="fixed inset-0 z-[9999] flex justify-end">
      ...
      <aside className="relative z-10 flex h-[100dvh] max-h-[100dvh] w-full max-w-[350px] flex-col overflow-hidden border-l border-zinc-200 bg-white p-4 opacity-100 shadow-2xl sm:p-5" aria-label="Buyer account menu">
