    ...
    <div className="mx-auto max-w-6xl px-5 py-6 sm:px-8 sm:py-8">
      ...
      <div className="mt-6 grid items-start gap-8 lg:grid-cols-[1.05fr_0.95fr] xl:gap-10">
        ...
        <section className="lg:sticky lg:top-20">
          ...
          {seller && <section className="mt-5 overflow-hidden rounded-3xl border border-zinc-200 bg-white shadow-sm"><div className="flex items-center gap-3 p-4 sm:p-5"><span className="grid h-12 w-12 shrink-0 place-items-center rounded-2xl bg-zinc-950 text-base font-black text-white">{seller.display_name.charAt(0).toUpperCase()}</span><div className="min-w-0 flex-1"><p className="text-[9px] font-black uppercase tracking-[0.14em] text-zinc-400">Seller profile</p><div className="mt-1 flex flex-wrap items-center gap-2"><p className="truncate text-base font-black">{seller.display_name}</p><span className="rounded-full bg-emerald-50 px-2 py-1 text-[9px] font-black uppercase text-emerald-700">✓ Verified</span></div></div><button onClick={() => navigate('/support')} className="rounded-full border border-zinc-200 px-3 py-2 text-[10px] font-black text-zinc-600">Contact</button></div><div className="grid grid-cols-3 border-t border-zinc-100 bg-zinc-50"><div className="p-3 text-center"><p className="text-xs font-black">Verified</p><p className="mt-1 text-[8px] font-bold uppercase tracking-wider text-zinc-400">Identity</p></div><div className="border-x border-zinc-200 p-3 text-center"><p className="text-xs font-black">{formatSellerDate(seller.created_at)}</p><p className="mt-1 text-[8px] font-bold uppercase tracking-wider text-zinc-400">Member since</p></div><div className="p-3 text-center"><p className="text-xs font-black">Protected</p><p className="mt-1 text-[8px] font-bold uppercase tracking-wider text-zinc-400">Transaction</p></div></div></section>}
