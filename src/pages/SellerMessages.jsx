...
export default function SellerMessages() {
  ...
  return <main className="min-h-screen bg-zinc-50 px-4 pb-16 pt-24 text-zinc-950 sm:px-8"><div className="mx-auto max-w-6xl">
    <header><p className="text-[10px] font-black uppercase tracking-[0.2em] text-[#a87300]">Private marketplace messages</p><h1 className="mt-2 text-3xl font-black tracking-[-0.04em] sm:text-5xl">Seller chat</h1><p className="mt-3 text-sm text-zinc-500">Ask about a listing and keep all product communication in one place.</p></header>
