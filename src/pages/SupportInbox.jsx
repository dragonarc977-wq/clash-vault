  ...
  useEffect(() => {
    ...
    const initialize = async () => {
      ...
      if (!roleError && access) {
        ...
        else { setTickets(data || []); setActiveId(data?.[0]?.id || null); }
      }
      setLoading(false);
    };
    initialize();
