  ...
  return <main className="min-h-screen bg-white pb-20 pt-16 text-zinc-950">
    <section className="border-b border-zinc-200 bg-zinc-50 px-5 py-8 sm:px-8 sm:py-12">
      <div className="mx-auto max-w-7xl">
        <div className="flex items-center gap-2 text-xs font-semibold text-zinc-500"><Link to="/" className="hover:text-zinc-950">Home</Link><span>/</span><Link to="/#games" className="hover:text-zinc-950">Games</Link><span>/</span><span className="text-zinc-950">{game.name}</span></div>
